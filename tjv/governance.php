...
<head>
    ...
    <title>Governence Of Telangana Jana Vedika</title>
...
<body>
    ...
    <style>
        *{
        ...
        .Governence-img-container{
            width:50%;
            height:90%;
            padding:30px;
            justify-content:center;
        }
        .Governence-img-container img{
            max-width:100%;
            max-height:100%;
            margin:auto;
            object-fit:contain;
        ...
        .Governence-text-container .title{
            font-weight:600;
            font-size:18px;
            margin:10px 0;
            cursor: pointer;
        ...
        .Governence-text-container .text{
            margin:10px 0;
        }
        .footer-items{
            margin-top:50px;
