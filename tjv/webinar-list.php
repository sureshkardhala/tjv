<div class="webinar-list-container">
    <div class="webinar-list-header">
        <h2 class="webinar-list-head-title"><a href="webinars.php">webinars</a></h2>
    ...
    <div class="webinar-list-sub-container">
        <div class="webinar-list-items">
            ...
            <div class="webinar-list-text-container">
                <h2 class="webinar-list-title"><a href="#">2నీరు-నిత్యజీవనాధారం Water - Elixir of Life Lorem ipsum dolor sit amet consectetur, adipisicing elit. Debitis harum suscipit odit nobis tempore neque repellat ullam minus labore a.</a></h2>
                <p class="meeting">  <span>WEBINAR TIMINGS:</span> April 17 2022 05:30 PM</p>
