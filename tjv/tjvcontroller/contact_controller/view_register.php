...
<div class="webinar-list-container">
    <div class="webinar-list-header">
        <h2 class="webinar-list-head-title"><a>Registeration Details</a></h2>
    </div>
    ...
    ?>
        <div class="webinar-list-items">
            <div class="webinar-list-text-container">
                <h2 class="webinar-list-title"><a href="#">&nbsp;&nbsp;<?php echo $row['name'];?></a></h2>
                <p class="meeting">Email: &nbsp; &nbsp;<?php echo $row['email'];?></p>
                <p class="meeting">Phone: &nbsp; &nbsp;<?php echo $row['phone'];?></p>
